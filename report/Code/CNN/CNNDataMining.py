...
############################
# Creator of the File: Sadegh Naderi
# Date created: 08.12.2023
# Path: ML23-01-Keyword-Spotting-with-an-Arduino-Nano-33-BLE-Sense\report\Code\CNN\CNNDataMining.py
# Version: 2.0
...
# - Documented by Sadegh Naderi on 08.12.2023.
...
# - Original code by Sewak et al in the book "Practical Convolutional Neural Networks: Implement Advanced Deep Learning
# Models Using Python." Packt Publishing Ltd, 2018. isbn: 9781788392303
# - Modified and documented by Sadegh Naderi on 08.12.2023.
#
...
# Plot the first nine images in the training dataset
